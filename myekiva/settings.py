"""
Django settings for myekiva project.
...
SECRET_KEY = 'django-insecure-7wf&(ugst2#rd-($+mf@#j(6k&!x2ot^0h$pany890@#1wkgd7'
...
WSGI_APPLICATION = 'myekiva.wsgi.application'
